...
public class ModuleUtils {
    ...
    public static void createTestModule(String moduleName, String moduleXml, File f, Class<?>... classes) throws IOException {
        ...
        jar.addAsManifestResource(f, "persistence.xml");
